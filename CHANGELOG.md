...
## [3.0.1] - 2026-xx-xx not yet released

### Changed

- Update jeap-spring-boot-parent from 34.7.0-alpha-springboot4 to 34.12.0-alpha-springboot4

## [3.0.0] - 2026-xx-xx not yet released
...
- Redirect to first wizard step when navigating directly to later steps without required state, preventing NPEs
...
- Update parent from 30.11.0 to 30.14.0

## [2.41.2] - 2026-01-21

### Changed

- Avoid showing duplicate platforms in platform selection step

## [2.41.1] - 2026-01-21

### Changed

- Remove local override of jacoco maven plugin version

## [2.41.0] - 2026-01-20

### Changed

- UI: New first wizard step to select a platform
- Add "platform" property to templates to distinguish templates for different platforms
